...
import com.bizmiz.kvartirabor.databinding.FragmentSotishElonlarBinding
import com.bizmiz.kvartirabor.ui.MainActivity
import org.koin.androidx.viewmodel.ext.android.viewModel

class SotishElonlarFragment : Fragment(R.layout.fragment_sotish_elonlar) {
    private lateinit var binding: FragmentSotishElonlarBinding
    private val sotishElonlarViewModel: SotishElonlarViewModel by viewModel()
    lateinit var adapter: ElonlarAdapter
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        sotishElonlarViewModel.getSotishData()
    }

    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        super.onViewCreated(view, savedInstanceState)
        binding = FragmentSotishElonlarBinding.bind(view)
        ...
        binding.txtSearch.setOnClickListener {
            ...
            navController.navigate(R.id.action_sotishElonlarFragment_to_searchFragment)
        }
        isSotishObserve()
    ...
    private fun isSotishObserve() {
        sotishElonlarViewModel.sotish.observe(viewLifecycleOwner, Observer {
                ...
                ResourceState.SUCCESS -> {
                    ...
                    adapter.setOnClickListener { data ->
                        ...
                        navController.navigate(
                            R.id.action_sotishElonlarFragment_to_elonFullFragment,
                            bundle
                        )
                    }
                    if (!isNetworkAvialable()) {
